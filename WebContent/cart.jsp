      ...
      <!--start cart loop  -->
        ...
        <div class="col-md-4 order-md-2 mb-4">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            ...
            <span class="badge badge-secondary badge-pill">${cartCars.size()}</span>
          </h4>
          <ul class="list-group mb-3">
          <c:forEach var="car" items="${cartCars}" >
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0">Product name</h6>
                <small class="text-muted">${car.year} ${car.make} ${car.model} ${car.condition}</small>
              </div>
              <span class="text-muted">${car.price}</span>
              ${car.carId}
            </li>
            
            <a href="deleteCartservlet?carId=${car.carId}"><button type="button" class="btn btn-outline-warning">Remove Cart</button></a>
           </c:forEach>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate="" method="get" action="checkOutServlet">
            <div class="row">
            ...
            <div class="mb-3">
              <label for="email"> Create Password <span class="text-muted"></span></label>
